...
module.exports.index = (input, callback) => {
	...
	async.waterfall([
		(flowCallback) => {
			province.findAll({limit, offset}, (err, result) => {
...
module.exports.store = (input, callback) => {
	...
	async.waterfall([
		(flowCallback) => {
			province.insertOne(input, (err, result) =>{
				if (err) { return flowCallback(err); }
...
module.exports.update = (id, input, callback) => {
	...
	async.waterfall([
		(flowCallback) => {
			province.update(id, input, (err, result) => {
				if (err) { return flowCallback(err); }
...
module.exports.destroy = (id, input, callback) => {
	...
	async.waterfall([
		(flowCallback) => {
			province.delete(id, input, (err, result) => {
				if (err) { return flowCallback(err); }
